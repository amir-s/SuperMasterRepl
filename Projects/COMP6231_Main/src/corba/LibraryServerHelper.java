...
public class LibraryServerHelper
{
     ...
     */
    public static void insert(org.omg.CORBA.Any a, corba.LibraryServer t)
    {
     ...
     */
    public static corba.LibraryServer extract( org.omg.CORBA.Any a )
    {
        ...
        try
        {
            return corba.LibraryServerHelper.narrow( a.extract_Object() );
        }
    ...
    private final static String _id = "IDL:corba/LibraryServer:1.0";
     ...
     */
    public static corba.LibraryServer read(org.omg.CORBA.portable.InputStream istream)
    {
        return(corba.LibraryServer)istream.read_Object(corba._LibraryServerStub.class);
    }
     ...
     */
    public static void write(org.omg.CORBA.portable.OutputStream ostream, corba.LibraryServer value)
    {
